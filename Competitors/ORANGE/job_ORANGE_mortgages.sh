...
#SBATCH --job-name=ORANGE_mortgages
...
run_with_timing "preprocess.py --log mortgages"
run_with_timing "ae.py --log mortgages --epochs 200 --batch_size 64"
run_with_timing "generate_image.py --log mortgages"
run_with_timing "nn.py --log mortgages --learning_rate 0.0001 --batch_size 64"
run_with_timing "load_weights.py --log mortgages"
run_with_timing "roc_auc_plotting.py --log mortgages"
run_with_timing "eval_pred.py --log mortgages"
