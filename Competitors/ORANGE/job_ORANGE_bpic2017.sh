...
run_with_timing "preprocess.py --log bpic2017"
run_with_timing "ae.py --log bpic2017 --epochs 200 --batch_size 64"
run_with_timing "generate_image.py --log bpic2017"
run_with_timing "nn.py --log bpic2017 --learning_rate 0.0001 --batch_size 64"
run_with_timing "load_weights.py --log bpic2017"
run_with_timing "roc_auc_plotting.py --log bpic2017"
run_with_timing "eval_pred.py --log bpic2017"
