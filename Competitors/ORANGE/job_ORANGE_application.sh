...
#SBATCH --job-name=ORANGE_application
...
run_with_timing "ae.py --log application --epochs 200 --batch_size 64"
run_with_timing "generate_image.py --log application"
run_with_timing "nn.py --log application --learning_rate 0.0001 --batch_size 64"
run_with_timing "load_weights.py --log application"
run_with_timing "roc_auc_plotting.py --log application"
run_with_timing "eval_pred.py --log application"
