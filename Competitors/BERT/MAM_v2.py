...
class MaskedActivityDataset(Dataset):
    def __init__(self, data_file, tokenizer, mask_prob=0.15):
        ...
        self.max_len = min(512, self.get_max_trace_length())  # Ensure max length doesn't exceed BERT's limit
...
def setup_training(
        ...
        print_examples=False, save_model=True, save_path=output_dir+'/saved_model'):
    """
...
setup_training(
    ...
    save_model=True, save_path=output_dir+'/mam_pretrained_model')
