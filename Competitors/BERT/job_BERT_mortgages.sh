...
#SBATCH --job-name=BERT_mortgages
...
run_with_monitoring "data_processor.py --log mortgages"
run_with_monitoring "MAM_v2.py --log mortgages"
run_with_monitoring "nap_finetuning.py --log mortgages"
run_with_monitoring "outcome_finetuning.py --log mortgages"
