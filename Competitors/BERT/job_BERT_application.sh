...
#SBATCH --job-name=BERT_application
...
run_with_monitoring "data_processor.py --log application"
run_with_monitoring "MAM_v2.py --log application"
run_with_monitoring "nap_finetuning.py --log application"
run_with_monitoring "outcome_finetuning.py --log application"
